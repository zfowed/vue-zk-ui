<template>
  <app-page title="Typography 字体" description="我们对字体进行统一规范，力求在各个操作系统下都有最佳展示效果。">
    <h2>中文字体</h2>
    <div>
